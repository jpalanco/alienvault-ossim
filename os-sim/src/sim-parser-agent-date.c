...
SimCommand *
sim_parser_bson_agent_date (SimParser * self, bson_iter_t * piter)
{
  ...
  /* Well, looking in SIM_COMMAND, we discard all information about the agent , I'm not going to parse it */
  cmd->type = SIM_COMMAND_TYPE_AGENT_DATE;
  return cmd;
}
