...
<html>
   <head>
    ...
    <body>
        <center><div id="plotareaglobal" class="plot" style="text-align:center;margin:0px; top: 12px; left: -30px;"></div></center>
        ...
        if (count($y) > 1)
        {
            ...
            $plot = plot_graphic("plotareaglobal", 60, 650, $x, $y, $xticks, $xlabels, false, 'base_qry_main.php?num_result_rows=-1&current_view=-1');
