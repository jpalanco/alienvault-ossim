 ...
 *
 * Upgraded to Javascript plotting library for jQuery (FLOT), v. 0.5, by Scott Montgomerie, June 2009. 
 */
...
//PIE: skip any data processing
        ...
        function drawSeriesPie(serie){
			...
			if (options.pie.showLabel && typeof(options.pie.labelFormatter) == 'function') {
				...
				var html = '<span  class="pieLabel" id="pieLabel'+pieArcIndex+'_'+randomnumber+'" style="position:absolute;top:' + (plotOffset.top + yh) + 'px;left:' + (plotOffset.left + xh) + 'px;"><div>' + text + "</div></span>";
				target.append(html);
				var label = $('#pieLabel'+pieArcIndex+'_'+randomnumber);
