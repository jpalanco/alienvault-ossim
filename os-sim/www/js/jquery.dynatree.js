...
//				$(this.span).addClass(this.tree.options.classNames.nodeError);
				this._setStatusNode({
					...
					title: this.tree.options.strings.NoData,
					tooltip: tooltip,
					addClass: this.tree.options.classNames.nodeNoData
				});
				break;
			default:
...
//				self.tree.logDebug("appendAjax().success");
				...
				// Set Iframe height if function exists
				if (typeof parent.doIframe == 'function') { parent.doIframe(); }
				},
...
*/
	...
	bind: function() {
		...
		this.element.bind('contextmenu', function(e){e.preventDefault()});
		
		var eventNames = "click.dynatree mousedown.dynatree dblclick.dynatree";
		...
		this.element.bind(eventNames, function(event){
			...
			try {
				...
				case "mousedown":
					...
					if(event.which === 3)
					{
						return ( o.onRightClick && o.onRightClick.call(tree, dtnode, event)===false ) ? false : dtnode._onRightClick(event);
					}
...
$.ui.dynatree.prototype.options = {
	...
	onRightClick: null, // (No default actions.)
...
//		document: "dynatree-document",
		...
		nodeNoData: "dynatree-statusnode-nodata",
