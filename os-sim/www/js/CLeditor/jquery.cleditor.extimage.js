/**
 ...
 2012-02-01 Modified by @jmalbarracin. Added prefix
*/
...
(function($) {
	...
	$.cleditor.buttons.image = {
		...
		popupContent:
			...
			'<input id="imagePrefix" name="prefix" type="hidden" value="" />' +
		...
		$(data.popup)
			...
			.bind("click", function(e) {
				if($file.val()) { // proceed if any file was selected
					...
					$('#imagePrefix',data.popup).val($.cleditor.buttons.image.prefix);
