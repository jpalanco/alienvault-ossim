...
if ($action == 'newincident' || $action == 'editincident') /* Create or modify an incident */
{
	...
	if ($ref == 'Alarm' || $ref == 'Event')
	{
		$validate_2 = array (
            ...
            'src_ports'       => array('validation' => 'OSS_PORT, OSS_NULLABLE',                                     'e_message' => 'illegal:' . _('Source Ports')),
            'dst_ports'       => array('validation' => 'OSS_PORT, OSS_NULLABLE',                                     'e_message' => 'illegal:' . _('Dest Ports')),
...
elseif ($action == 'newticket') /* Create a new ticket */
{
	...
	else
	{
		...
		$incident_id         =  POST('incident_id');
		$prev_prio           =  intval(POST('prev_prio'));
