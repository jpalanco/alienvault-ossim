...
if ( Session::menu_perms("analysis-menu", "EventsForensics") ) 
{
    ...
    $list = $pdf->IncidentSummaryNoPDF($title , "Event", '', null, $args, null, $conn1, $user);
    ...
    if ( $size > 0 )
    {
        $htmlPdfReport->set('
                    <tr>
                        ...
                        <th style="width:61mm;" class="center">'._("Event").'</th>
                        <th style="width:30mm;" class="center">'._("Date").'</th>
                        <th style="width:61mm;" class="center">'._("Event").'</th>
                    </tr>');
    ...
    {
        $htmlPdfReport->set("<tr><td class='nobborder w100' style='padding: 5px 0px; text-align:center;'>"._("No Events with this criteria")."</td></tr>");
    }
    
    $htmlPdfReport->set('</table>');
        
    $list = null;
    $ids  = $pdf->get_event_ids(null, $args, $user, null, $conn1);     
