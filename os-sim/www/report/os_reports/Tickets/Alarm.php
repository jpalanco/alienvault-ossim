...
if ( Session::menu_perms("analysis-menu", "EventsForensics") ) 
{
    ...
    if ( $size > 0 )
    {
        $htmlPdfReport->set('
                    <tr>
                        ...
                        <th style="width:61mm;" class="center">'._("Alarm").'</th>
                        <th style="width:30mm;" class="center">'._("Date").'</th>
                        <th style="width:61mm;" class="center">'._("Alarm").'</th>
                    </tr>');
    ...
    {
        $htmlPdfReport->set("<tr><td class='nobborder w100' style='padding: 5px 0px; text-align:center;'>"._("No Alarms with this criteria")."</td></tr>");
    }
    
    $htmlPdfReport->set('</table>');
        
    $list = null;
    $ids  = $pdf->get_alarm_ids(null, $args, $user, null, $conn1);     
            ...
            $htmlPdfReport->set('
                <td style="width: 93mm; padding: 0px;" valign="top">
                    <table style="'.$padding.'; width: 93mm;" align="center">
                        <tr>
                            <th colspan="4" style="width: 93mm; text-align:center;">'.Util::wordwrap($value['Title'], 40, "<br/>", true).'</th>
                        </tr>
                        <tr>
                            <td style="'.$td_style.' width: 27mm;" class="noborder"><strong>'.gettext("Source ips").':</strong></td>
                            <td style="'.$td_style.' width: 26mm;" class="noborder">'.str_replace("," ,"<br/>", $value['SourceIps']).'</td>
                            <td style="'.$td_style.' width: 20mm;" class="noborder"><strong>'.gettext("Status").':</strong></td>
                            <td style="'.$td_style.' width: 20mm;" class="noborder">'.$imgStatus.' '.$value['Status'].'</td>
                        </tr>
                        <tr>
