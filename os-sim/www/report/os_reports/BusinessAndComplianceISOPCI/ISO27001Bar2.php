...
(select 'Business requirement for access control', count(*) as volume from datawarehouse.ssi_user a,
datawarehouse.iso27001sid i
where ".$sql_year." AND a.user = '".$user."' AND a.sid=i.sid and i.ref IN (SELECT ref from
ISO27001An.A11_Acces_control ) AND i.ref LIKE 'A.11.1.%') as A_11_1
UNION SELECT * FROM
(select 'User access management', count(*) as volume from datawarehouse.ssi_user a, datawarehouse.iso27001sid i
where ".$sql_year." AND a.user = '".$user."' AND a.sid=i.sid and i.ref IN (SELECT ref from
ISO27001An.A11_Acces_control ) AND i.ref LIKE 'A.11.2.%') as A_11_2
UNION SELECT * FROM
(select 'User responsibilities', count(*) as volume from datawarehouse.ssi_user a, datawarehouse.iso27001sid i
where ".$sql_year." AND a.user = '".$user."' AND a.sid=i.sid and i.ref IN (SELECT ref from
ISO27001An.A11_Acces_control ) AND i.ref LIKE 'A.11.3.%') as A_11_3
UNION SELECT * FROM
(select 'Network access control', count(*) as volume from datawarehouse.ssi_user a, datawarehouse.iso27001sid i
where ".$sql_year." AND a.user = '".$user."' AND a.sid=i.sid and i.ref IN (SELECT ref from
ISO27001An.A11_Acces_control ) AND i.ref LIKE 'A.11.4.%') as A_11_4
UNION SELECT * FROM
(select 'Operating system access control', count(*) as volume from datawarehouse.ssi_user a,
datawarehouse.iso27001sid i
where ".$sql_year." AND a.user = '".$user."' AND a.sid=i.sid and i.ref IN (SELECT ref from
ISO27001An.A11_Acces_control ) AND i.ref LIKE 'A.11.5.%') as A_11_5
UNION SELECT * FROM
(select 'Application and information access control', count(*) as volume from datawarehouse.ssi_user a,
datawarehouse.iso27001sid i
where ".$sql_year." AND a.user = '".$user."' AND a.sid=i.sid and i.ref IN (SELECT ref from
ISO27001An.A11_Acces_control ) AND i.ref LIKE 'A.11.6.%') as A_11_6
UNION SELECT * FROM
(select 'Mobile computing and teleworking', count(*) as volume from datawarehouse.ssi_user a,
datawarehouse.iso27001sid i
where ".$sql_year." AND a.user = '".$user."' AND a.sid=i.sid and i.ref IN (SELECT ref from
ISO27001An.A11_Acces_control ) AND i.ref LIKE 'A.11.7.%') as A_11_7
) AS alliso;";
...
$var=array();
while (!$rs->EOF) {
    $var1 = $rs->fields["Business requirement for access control"];
