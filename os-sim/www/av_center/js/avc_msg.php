...
echo "var labels = new Array();
	...
	labels['sw_pending']      = '"._("Checking updating process in progress")."';
	labels['sw_update']       = '"._("Checking software updates. This process can take several minutes")."';
	...
	labels['delete_msg']      = '".Util::js_entities(_("Are you sure you want to delete this system?")).".';
