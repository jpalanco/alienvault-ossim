    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        var series = [],
            options = {
                ...
                colors: ["#94cf05", "#0991d1", "#fac800", "#7d71bd", "#fa0000"],
                legend: {
                    show: true,
        ...
        function insertLegend() {
            ...
            for (var i = 0; i < series.length; ++i) {
                ...
                fragments.push(
                    '<td class="legendColorBox"><div><div class="jqplot-table-legend-swatch" style="background-color:' + s.color + '"></div></div></td>' +
            ...
            var table = '<table style="border:none;vertical-align:middle;color:' + options.grid.color + '">' + fragments.join("") + '</table>';
