...
window.onload = function () 
{
    ...
    var color = '#94cf05',
        ...
        txt2 = {font: '12px Helvetica, Arial', fill: "#BCBCBC"},
    ...
    r.drawGrid(leftgutter + X * .5 + .5, topgutter + .5, width - leftgutter - X, height - topgutter - bottomgutter, labels.length - 1, 4, "#EEE");
