...
echo "var ossec_msg = new Array();
          ...
          ossec_msg['add_agent']            = '".Util::js_entities(_("Are you sure you want to continue?"))."';
          ossec_msg['link_asset']           = '".Util::js_entities(_("Are you sure you want to continue?"))."';
          ossec_msg['p_action']             = '"._("Processing action")." ...';
          ossec_msg['cnf_a_error']          = '"._("Error! HIDS configuration not updated successfully")."';
          ...
          ossec_msg['no_trend_chart']       = '"._("Trend chart not available")."';
          ...
          ossec_msg['deploying_agent']      = '"._("Deploying HIDS agent")." ...';
          ossec_msg['gb_link_asset']        = '"._("Connect an Asset to HIDS agent")."';
          ";
