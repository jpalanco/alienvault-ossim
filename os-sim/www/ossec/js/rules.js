...
function load_interface(tab)
{
    ...
    $.ajax({
        type: "POST",
        url: "data/ossec_rules/ajax/load_tabs.php",
...
{   
    ...
    $.ajax({
        type: "POST",
        url:  "data/ossec_rules/ajax/get_rule_files.php",
...
function load_tree(encode_tree, key)
{
    ...
    $(layer).html("<div class='reload'><img src='../pixmaps/theme/loading2.gif' border='0' align='absmiddle'/>"+ossec_msg['reloading']+"</div>");
...
{   
    ...
    $.ajax({
        type: "POST",
        url: "data/ossec_rules/ajax/get_tree.php",
        dataType: 'json',
        ...
        error: function(data){
            ...
            tree = "{title:'<span>"+rule_file+"</span>', icon:'../../pixmaps/theme/any.png', addClass:'size12', isFolder:'true', key:'1', children:" +
...
function load_tab2(file)
{
    ...
    $.ajax({
        ...
        dataType: 'json',
        url:  "data/ossec_rules/ajax/get_xml_file.php",
        beforeSend: function(xhr){ 
...
function save(editor)
{
    ...
    $.ajax({
        type: "POST",
        url:  "data/ossec_rules/ajax/save.php",
        dataType : 'json',
...
function countdown(seconds)
{
    ...
    else
    {
        ...
        document.location.href = '/ossim/ossec/index.php?sensor_id='+sensor_id;
    }
}
...
{   
    ...
    $.ajax({
        type: "POST",
        url:  "data/ossec_rules/ajax/modify_rule.php",
...
{   
   ...
   if (key != 1 && key != 'load_error')
   {
        ...
        $.ajax({
            type: "POST",
            url:  "data/ossec_rules/ajax/get_interfaces.php",
            data: data,
            beforeSend: function(xhr){
...
{   
    ...
    {   
        $.ajax({
            type: "POST",
            url: "data/ossec_rules/ajax/get_xml_node.php",
