...
{
    $output_name = _("Assets_from_net_$net_id") .'__' . gmdate('Y-m-d', time()) . '.csv';
...
<head>
    ...
    <script type='text/javascript'>
        ...
        function get_csv_data()
        {
            ...
            {
                type: "GET",
                url: __cfg.network.views + "export_net.php",
                data: "get_data=1&net_id=<?php echo $net_id?>",
                success: function(html)
                {
                    $("#export_csv").attr("action", __cfg.network.views + "export_net.php");
                    ...
                    setTimeout(function()
                    {
                        document.location.href = __cfg.network.detail + "?asset_id=<?php echo $net_id?>";
                    }, 1000);
                }
            });
        }
    ...
    <div id='container'>
        <div id='loading'>
            <div>
                ...
                <span><?php echo _('Exporting Assets from Network to CSV')?>.</span>
