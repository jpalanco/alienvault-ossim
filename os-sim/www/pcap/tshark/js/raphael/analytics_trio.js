...
window.onload = function () {
    ...
    var color = '#8DC41B',
        ...
        max3 = Math.max.apply(Math, data3);
    var max = (max1>max2) ? max1 : max2;
    var max = (max>max3) ? max : max3;
    ...
    for (var i = 0, ii = labels.length; i < ii; i++) {
        ...
        (function (x, y, y1, data, data1, lbl, dot, dot1) {
            ...
            rect.hover(function () {
                ...
                if (dify<=25) { // so closer
	                ...
	                label3[0].attr({text: data + " Security event" + (data == 1 ? "" : "s")}).show().stop().animateWith(frame2, {translation: [ppp.dx, ppp.dy]}, 200 * is_label_visible2);
	                label3[1].attr({text: data1 + " Log event" + (data1 == 1 ? "" : "s")}).show().stop().animateWith(frame2, {translation: [ppp.dx, ppp.dy]}, 200 * is_label_visible2);
	                ...
	                label2[0].attr({text: data1 + " Log event" + (data1 == 1 ? "" : "s")}).show().stop().animateWith(frame2, {translation: [ppp.dx, ppp.dy]}, 200 * is_label_visible2);
	                ...
	                label[0].attr({text: data + " Security event" + (data == 1 ? "" : "s")}).show().stop().animateWith(frame, {translation: [ppp1.dx, ppp1.dy]}, 200 * is_label_visible2);
        ...
        })(x, y, y1[i], data[i], data2[i], data3[i], labels[i], dot, dot1[i]);
    }
