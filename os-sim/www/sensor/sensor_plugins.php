...
<table class="t_sensors noborder" cellpadding='0' cellspacing='0' style="margin-top:35px">
					...
					*/
					if ($use_munin == 1) 
					{
				        ...
				        if (is_array($data)) 
				        {
				            ...
				            {
				                if (preg_match("/Error\s+404/i",$line))
				                {
    				                $munin_valid = FALSE;
				                }				                    
				            }
						...
						{
							?>
							<img align="bottom" src="../pixmaps/chart_bar_off.png" border="0"/>
							<?php
						}
					}
					?>	
